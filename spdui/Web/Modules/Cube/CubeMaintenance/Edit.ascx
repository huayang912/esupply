...
function ButtonWarning(Action)
    ...
    <div class="BGform">
        <table border="0">
            ...
            <tr>
                <td class="txtForm">
                    Process Cube Name:</td>
                <td>
                    <asp:TextBox ID="txtProcessCubeName" runat="server"></asp:TextBox></td>
                <td class="txtForm">
                    Process Server Address:</td>
                <td>
                    <asp:TextBox ID="txtProcessServerAddr" runat="server" Width="400"></asp:TextBox></td>
            </tr>
            <tr>
                <td class="txtForm">
                    Process Database Name:</td>
                <td>
                    <asp:TextBox ID="txtProcessDatabaseName" runat="server"></asp:TextBox></td>
                <td class="txtForm">
                    Process Cube Backup Folder:</td>
                <td colspan="3">
                    <asp:TextBox ID="txtProcessBackupFolder" runat="server" Width="400"></asp:TextBox></td>
            </tr>
            <tr>
                <td class="txtForm">
                    Release Cube Name:</td>
                <td>
                    <asp:TextBox ID="txtReleaseCubeName" runat="server"></asp:TextBox></td>
                <td class="txtForm">
                    Release Server Address:</td>
                <td>
                    <asp:TextBox ID="txtReleaseServerAddr" runat="server" Width="400"></asp:TextBox></td>
            </tr>
            <tr>
                <td class="txtForm">
                    Release Database Name:</td>
                <td>
                    <asp:TextBox ID="txtReleaseDatabaseName" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
            ...
            <tr>
                <td valign="top" class="txtForm">
                    SQL After Process Run:</td>
                <td colspan="3">
                    &nbsp;<asp:TextBox ID="txtPostProcessSQL" runat="server" Columns="100" Rows="15"
                        TextMode="MultiLine"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td valign="top" class="txtForm">
                    SQL Before Release Run:</td>
                <td colspan="3">
            ...
            <tr>
                <td valign="top" class="txtForm">
                    SQL After Release Run:</td>
                <td colspan="3">
                    &nbsp;<asp:TextBox ID="txtPostReleaseSQL" runat="server" Columns="100" Rows="15"
                        TextMode="MultiLine"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td valign="top" class="txtForm">
                    SQL Before UpdateRole Run:</td>
                <td colspan="3">
                    &nbsp;<asp:TextBox ID="txtPreUpdateRoleSQL" runat="server" Columns="100" Rows="15"
                        TextMode="MultiLine"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td valign="top" class="txtForm">
                    SQL After UpdateRole Run:</td>
                <td colspan="3">
                    &nbsp;<asp:TextBox ID="txtPostUpdateRoleSQL" runat="server" Columns="100" Rows="15"
                        TextMode="MultiLine"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td valign="top" class="txtForm">
                    SQL Before UpdateDescription Run:</td>
                <td colspan="3">
                    &nbsp;<asp:TextBox ID="txtPreUpdateDescriptionSQL" runat="server" Columns="100" Rows="15"
                        TextMode="MultiLine"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td valign="top" class="txtForm">
                    SQL After UpdateDescription Run:</td>
                <td colspan="3">
                    &nbsp;<asp:TextBox ID="txtPostUpdateDescriptionSQL" runat="server" Columns="100"
    ...
    <asp:GridView runat="server" ID="gvRuleList" AutoGenerateColumns="False" PageSize="20"
        DataKeyNames="Id" CellPadding="4" CssClass="list" GridLines="Horizontal" OnRowDataBound="gvRule_OnRowDataBound">
        <HeaderStyle CssClass="listheader" />
        <Columns>
            <asp:TemplateField>
                <ItemTemplate>
    ...
    <p class="formBtnBoard">
        <asp:Button ID="btnAddMeasure" runat="server" Text="Add Measure" Width="100px" OnClick="btnAddMeasure_Click"
            CssClass="btn" />
        <asp:Button ID="btnDeleteMeasure" runat="server" Text="Delete" OnClick="btnDeleteMeasure_Click"
            CssClass="btn" OnClientClick="return ButtonWarning('Delete')" />
    </p>
    <asp:GridView runat="server" ID="gvMeasureList" AutoGenerateColumns="False" PageSize="20"
        DataKeyNames="Id" CellPadding="4" CssClass="list" GridLines="Horizontal">
        <HeaderStyle CssClass="listheader" />
        <Columns>
            <asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Measure Name">
                <ItemTemplate>
                    <asp:LinkButton ID="lbtnMeasureName" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Name") %>'
                        CommandName="Select" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Id") %>'
                        OnClick="lbtnMeasureName_Click"></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
    ...
    <p class="formBtnBoard">
        <asp:Button ID="btnAddDimension" runat="server" Text="Add Dimension" Width="100px"
            OnClick="btnAddDimension_Click" CssClass="btn" />
        <asp:Button ID="btnDeleteDimension" runat="server" Text="Delete" OnClick="btnDeleteDimension_Click"
            CssClass="btn" OnClientClick="return ButtonWarning('Delete')" />
    </p>
    <asp:GridView runat="server" ID="gvDimensionList" AutoGenerateColumns="False" PageSize="20"
        DataKeyNames="Id" CellPadding="4" CssClass="list" GridLines="Horizontal">
        <HeaderStyle CssClass="listheader" />
        <Columns>
            <asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Dimension Name">
                <ItemTemplate>
                    <asp:LinkButton ID="lbtnDimensionName" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "DimensionName") %>'
                        CommandName="Select" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Id") %>'
                        OnClick="lbtnDimensionName_Click"></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
    ...
    <b>Warm MDX:</b>
    <p class="formBtnBoard">
        <asp:Button ID="btnAddMDX" runat="server" Text="Add MDX" Width="100px" OnClick="btnAddMDX_Click"
            CssClass="btn" />
        <asp:Button ID="btnDeleteMDX" runat="server" Text="Delete" OnClick="btnDeleteMDX_Click"
            CssClass="btn" OnClientClick="return ButtonWarning('Delete')" />
    </p>
    <asp:GridView runat="server" ID="gvMDXList" AutoGenerateColumns="False" PageSize="20"
        DataKeyNames="Id" CellPadding="4" CssClass="list" GridLines="Horizontal">
        <HeaderStyle CssClass="listheader" />
        <Columns>
            <asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Description">
                <ItemTemplate>
                    <asp:LinkButton ID="lbtnDescription" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Description") %>'
                        CommandName="Select" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Id") %>'
                        OnClick="lbtnMDX_Click"></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
        <AlternatingRowStyle CssClass="listA" />
