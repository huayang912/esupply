<%@ Control Language="C#" AutoEventWireup="true" CodeFile="NewRule.ascx.cs" Inherits="Modules_Cube_CubeMaintenance_NewRule" %>
<asp:HiddenField ID="txtCubeId" runat="server" />
<asp:HiddenField ID="txtCubeRuleId" runat="server" />
...
<div class="BGform">
    <table border="0" cellpadding="1" cellspacing="2">
        ...
        <tr>
            ...
            <td class="txtForm">
                Validation Target:</td>
            <td>
                &nbsp;<asp:RadioButton ID="rdoValidationTargart_SPDW" Checked="true" GroupName="rdoValidationTargart"
                    runat="server" Text="SPDW" />
                &nbsp;&nbsp;
                <asp:RadioButton ID="rdoValidationTargart_CubeDB" GroupName="rdoValidationTargart"
                    runat="server" Text="CubeDB" /></td>
        </tr>
        <tr>
            <td class="txtform">
                Dependence Rule:</td>
