<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Edit.ascx.cs" Inherits="Modules_OffLineReport_ParameterMaintenance_Edit" %>
...
<h2>Report Parameter Maintanence</h2>
