...
<%@ Register Src="DWDSMerge.ascx" TagName="DWDSMerge" TagPrefix="uc3" %>
        ...
        <Columns>
            ...
            <asp:TemplateField ShowHeader="true" HeaderText="Action" meta:resourcekey="TemplateFieldResource8"
                ...
                <ItemTemplate>
                    ...
                    <asp:LinkButton ID="lbtnDownloadUpdate" runat="server" Text="[Download Updatable Data]"
                        CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Id")%>' CommandName="Select"
                        meta:resourcekey="lbtnUnconfirmResource" OnClick="lbtnDownloadUpdate_Click"></asp:LinkButton>&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <asp:LinkButton ID="lbtnMerge" runat="server" Text="[Merge Data]" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Id")%>'
                        Visible='<%# DataBinder.Eval(Container.DataItem, "MergeQuerySQL") != null && (DataBinder.Eval(Container.DataItem, "MergeQuerySQL").ToString().Length > 0) && DataBinder.Eval(Container.DataItem, "MergeSQL") != null && (DataBinder.Eval(Container.DataItem, "MergeSQL").ToString().Length > 0)%>'
                        CommandName="Select" meta:resourcekey="lbtnUnconfirmResource" OnClick="lbtnMerge_Click"></asp:LinkButton>&nbsp;&nbsp;&nbsp;&nbsp;
                </ItemTemplate>
...
<uc3:DWDSMerge ID="DWDSMerge1" runat="server" Visible="False" />