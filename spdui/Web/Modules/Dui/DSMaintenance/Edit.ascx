...
<table border="0">
	<tr>
        ...
        <td><asp:Label ID="txtName" runat="server"/></td>
...
<p class="formBtnBoard"><asp:Button ID="btnAddField" runat="server" Text="Add Field" Width="100px" OnClick="btnAddField_Click" CssClass="btn" />
<asp:Button ID="btnDeleteField" runat="server" Text="Delete" OnClick="btnDeleteField_Click" CssClass="btn"  OnClientClick="return ButtonWarning('Delete')"/>
</p>

<asp:GridView runat="server" ID="gvFieldList" AutoGenerateColumns="False" PageSize="20" DataKeyNames="Id" CellPadding="4" CssClass="list" GridLines="Horizontal">
     <HeaderStyle CssClass="listheader" HorizontalAlign="Left" />
            <Columns>
                ...
                <asp:TemplateField HeaderText="Allow Null">
                    <ItemTemplate>
                        <asp:CheckBox ID="cbAllowNull" runat="server" Enabled="false" Checked='<%# Eval("IsNullable") %>' CssClass=radio />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Data Key">
                    <ItemTemplate>
                        <asp:CheckBox ID="cbDataKey" runat="server" Enabled="false" Checked='<%# Eval("IsDataKey") %>' CssClass=radio />
                    </ItemTemplate>
                </asp:TemplateField>
...
<asp:GridView runat="server" ID="gvRuleList" AutoGenerateColumns="False" PageSize="20" DataKeyNames="Id" CellPadding="4" CssClass="list" GridLines="Horizontal">
         <HeaderStyle CssClass="listheader" />
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
...
<p class="formBtnBoard"><asp:Button ID="btnAddCategory" runat="server" Text="Add Category" Width="100px" OnClick="btnAddCategory_Click" CssClass="btn" />

<asp:Button ID="btnDeleteCategory" runat="server" Text="Delete" OnClick="btnDeleteCategory_Click" CssClass="btn"  OnClientClick="return ButtonWarning('Delete')"/>
</p>
<asp:GridView runat="server" ID="gvCategoryList" AutoGenerateColumns="False" PageSize="20" DataKeyNames="Id" CellPadding="4" CssClass="list" GridLines="Horizontal" >
         <HeaderStyle CssClass="listheader" />
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
...
<asp:Button ID="btnAddWithDrawTable" runat="server" Text="Add" Width="100px" OnClick="btnAddWithDrawTable_Click" CssClass="btn" />
<asp:Button ID="btnDeleteWithDrawTable" runat="server" Text="Delete" OnClick="btnDeleteWithDrawTable_Click" CssClass="btn"  OnClientClick="return ButtonWarning('Delete')"/>
</p>
<asp:GridView runat="server" ID="gvWithDrawTableList" AutoGenerateColumns="False" PageSize="20" DataKeyNames="Id" CellPadding="4" CssClass="list" GridLines="Horizontal" >
         <HeaderStyle CssClass="listheader" />
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
