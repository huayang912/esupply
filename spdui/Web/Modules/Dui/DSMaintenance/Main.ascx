<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Main.ascx.cs" Inherits="Modules_Dui_DSMaintenance_Main" %>
...
<p class="formBtnBoard">
            <asp:Button ID="btnNew" runat="server" Text="New Data Source" OnClick="btnNew_Click"  CssClass="btn" /> 
