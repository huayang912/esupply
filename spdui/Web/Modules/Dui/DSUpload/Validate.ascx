...
<h2>
    Data Preparation - Data Validation</h2>
<p class="formBtnBoard">
    <asp:Button ID="btnUpdate" Text="Update Subject" runat="server" OnClick="btnUpdate_Click"
        CssClass="btn" />
    ...
    <asp:Button ID="btnConfirm" Text="Confirm" runat="server" OnClick="btnConfirm_Click"
        OnClientClick="return ButtonWarning('Confirm')" CssClass="btn" />
    <asp:Button ID="btnUnConfirm" Text="UnConfirm" runat="server" OnClick="btnUnConfirm_Click"
        OnClientClick="return ButtonWarning('UnConfirm')" CssClass="btn" />
    <asp:Button ID="btnDelete" Text="Delete" runat="server" OnClick="btnDelete_Click"
        OnClientClick="return ButtonWarning('Delete')" CssClass="btn" />
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Action">
                        <ItemTemplate>
                            ...
                            <asp:LinkButton ID="lbtnErrorRuleUpdate" runat="server" Text="Update" CommandName="Select"
                                meta:resourcekey="lbtnErrorRuleStatusResource" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Id") %>'
                                Visible='<%# DataBinder.Eval(Container.DataItem, "Status") != null && DataBinder.Eval(Container.DataItem, "Status").Equals("Failed") && DataBinder.Eval(Container.DataItem, "TheDataSourceRule.UpdateContent") != null && DataBinder.Eval(Container.DataItem, "TheDataSourceRule.UpdateContent").ToString().Trim().Length > 0%>'
                                OnClick="gvValidationRuleUpdate_Click" />&nbsp;
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Action">
                        <ItemTemplate>
                            <asp:LinkButton ID="lbtnProblemRuleDownload" runat="server" Text="Download" CommandName="Select"
                                ...
                                Visible='<%# DataBinder.Eval(Container.DataItem, "Status") != null && DataBinder.Eval(Container.DataItem, "Status").Equals("Failed")%>'
                                OnClick="gvValidationRule_Click" />&nbsp;
                            <asp:LinkButton ID="lbtnProblemRuleUpdate" runat="server" Text="Update" CommandName="Select"
                                meta:resourcekey="lbtnProblemRuleStatusResource" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Id") %>'
                                Visible='<%# DataBinder.Eval(Container.DataItem, "Status") != null && DataBinder.Eval(Container.DataItem, "Status").Equals("Failed") && DataBinder.Eval(Container.DataItem, "TheDataSourceRule.UpdateContent") != null && DataBinder.Eval(Container.DataItem, "TheDataSourceRule.UpdateContent").ToString().Trim().Length > 0%>'
                                OnClick="gvValidationRuleUpdate_Click" />&nbsp;
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Action">
                        <ItemTemplate>
                            <asp:LinkButton ID="lbtnWarningRuleDownload" runat="server" Text="Download" CommandName="Select"
                                ...
                                Visible='<%# DataBinder.Eval(Container.DataItem, "Status") != null && DataBinder.Eval(Container.DataItem, "Status").Equals("Failed")%>'
                                OnClick="gvValidationRule_Click" />&nbsp;
                            <asp:LinkButton ID="lbtnWarningRuleUpdate" runat="server" Text="Update" CommandName="Select"
                                meta:resourcekey="lbtnWarningRuleStatusResource" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Id") %>'
                                Visible='<%# DataBinder.Eval(Container.DataItem, "Status") != null && DataBinder.Eval(Container.DataItem, "Status").Equals("Failed") && DataBinder.Eval(Container.DataItem, "TheDataSourceRule.UpdateContent") != null && DataBinder.Eval(Container.DataItem, "TheDataSourceRule.UpdateContent").ToString().Trim().Length > 0%>'
                                OnClick="gvValidationRuleUpdate_Click" />&nbsp;
                        </ItemTemplate>
