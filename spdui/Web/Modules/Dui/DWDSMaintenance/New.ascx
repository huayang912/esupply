...
<!-- Modified By Vincent On 2006-9-1 Begin -->
	...
	<tr>
        ...
        <td colspan="3"><asp:TextBox ID="txtDescription" runat="server" Columns="60" Rows="2" TextMode="MultiLine"></asp:TextBox></td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="txtForm"valign="top">All Data Query SQL:</td>
        <td colspan="3"><asp:TextBox ID="txtQuerySQL" runat="server" Columns="80" Rows="10" TextMode="MultiLine"/></td>
    </tr>
    <tr>
        <td class="txtForm" valign="top">Data to Delete Query SQL:</td>
        <td colspan="3"><asp:TextBox ID="txtDeleteQuerySQL" runat="server" Columns="80" Rows="10" TextMode="MultiLine"/></td>
    </tr>
    <tr>
        <td class="txtForm" valign="top">Delete Data SQL:</td>
        <td colspan="3"><asp:TextBox ID="txtDeleteSQL" runat="server" Columns="80" Rows="10" TextMode="MultiLine"/></td>
    </tr>
    <tr>
        <td colspan="4">
...
<b>Operators List:</b>
<p class="formBtnBoard">
<asp:Button ID="btnAddOperator" runat="server" Text="Add Operator" OnClick="btnAddOperator_Click" Width="100px" CssClass="btn" />
