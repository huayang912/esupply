<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ValidationRule.aspx.cs" Inherits="Popup_ValidationRule" %>
                         ...
                         <HeaderStyle CssClass="listheader" />
                           <Columns>                    
                            ...
                            <asp:TemplateField HeaderText="Rule Type">
                                <ItemTemplate>
                                    <%# DataBinder.Eval(Container.DataItem, "TheDataSourceRule.RuleType")%>
                                </ItemTemplate>
                            </asp:TemplateField>
