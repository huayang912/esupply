<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportJobValidationRule.aspx.cs" Inherits="Popup_ReportJobValidationRule" %>
    ...
    <div>
        <table border="0" width="100%">
            ...
            <tr>
                ...
                <td valign="top">
                    <asp:GridView width="100%" runat="server" ID="gvValidationRule" AutoGenerateColumns="False" DataKeyNames="Id" meta:resourcekey="gvValidationRuleResource" OnSelectedIndexChanged="gvValidationRule_SelectedIndexChanged"
                         ...
                         <HeaderStyle CssClass="listheader" />
                           <Columns>                    
                            ...
                            <asp:TemplateField HeaderText="Rule Type">
                                <ItemTemplate>
                                    <%# DataBinder.Eval(Container.DataItem, "TheRule.Type")%>
                                </ItemTemplate>
                            </asp:TemplateField>
