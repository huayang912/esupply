...
namespace Dndp.Persistence.Dao
{
    ...
    public class NHDaoBase : INHDao
    {
        ...
        public virtual Array FindAllWithCustomQuery(string queryString, object value)
        {
            return FindAllWithCustomQuery(queryString, new object[] { value }, (IType[])null, int.MinValue, int.MinValue);
        }

        public virtual Array FindAllWithCustomQuery(string queryString, object value, IType type)
        {
            return FindAllWithCustomQuery(queryString, new object[] { value }, new IType[] { type }, int.MinValue, int.MinValue);
        }

        public virtual Array FindAllWithCustomQuery(string queryString, object[] values)
        {
            return FindAllWithCustomQuery(queryString, values, (IType[])null, int.MinValue, int.MinValue);
        }

        public virtual Array FindAllWithCustomQuery(string queryString, object[] values, IType[] types)
        {
        ...
        public virtual Array FindAllWithCustomQuery(string queryString, object value, int firstRow, int maxRows)
        {
            return FindAllWithCustomQuery(queryString, new object[] { value }, (IType[])null, firstRow, maxRows);
        }

        public virtual Array FindAllWithCustomQuery(string queryString, object value, IType type, int firstRow, int maxRows)
        {
            return FindAllWithCustomQuery(queryString, new object[] { value }, new IType[] { type }, firstRow, maxRows);
        }

        public virtual Array FindAllWithCustomQuery(string queryString, object[] values, int firstRow, int maxRows)
        {
            return FindAllWithCustomQuery(queryString, values, (IType[])null, firstRow, maxRows);
        }

        public virtual Array FindAllWithCustomQuery(string queryString, object[] values, IType[] types, int firstRow, int maxRows)
		{
        ...
        public virtual Array FindAllWithNamedQuery(string namedQuery, object value)
        {
            return FindAllWithNamedQuery(namedQuery, new object[] { value }, (IType[])null, int.MinValue, int.MinValue);
        }

        public virtual Array FindAllWithNamedQuery(string namedQuery, object value, IType type)
        {
            return FindAllWithNamedQuery(namedQuery, new object[] { value }, new IType[] { type }, int.MinValue, int.MinValue);
        }

        public virtual Array FindAllWithNamedQuery(string namedQuery, object[] values)
        {
            return FindAllWithNamedQuery(namedQuery, values, (IType[])null, int.MinValue, int.MinValue);
        }

        public virtual Array FindAllWithNamedQuery(string namedQuery, object[] values, IType[] types)
        {
        ...
        public virtual Array FindAllWithNamedQuery(string namedQuery, object value, int firstRow, int maxRows)
        {
            return FindAllWithNamedQuery(namedQuery, new object[] { value }, (IType[])null, firstRow, maxRows);
        }

        public virtual Array FindAllWithNamedQuery(string namedQuery, object value, IType type, int firstRow, int maxRows)
        {
            return FindAllWithNamedQuery(namedQuery, new object[] { value }, new IType[] { type }, firstRow, maxRows);
        }

        public virtual Array FindAllWithNamedQuery(string namedQuery, object[] values, int firstRow, int maxRows)
        {
            return FindAllWithNamedQuery(namedQuery, values, (IType[]) null , firstRow, maxRows);
        }

        public virtual Array FindAllWithNamedQuery(string namedQuery, object[] values, IType[] types, int firstRow, int maxRows)
		{
