            ...
            <tr>
                <td class="toptdlogo">
                    <div style="z-index: 1;float:left;position:absolute;">
                        <asp:Image ID="imgTest" runat="server" ImageUrl="~/Images/Test_Lit.png" Visible="false" /></div>
                    <asp:Image ID="LeftImage" ImageAlign="Middle" NavigateUrl="~/Default.aspx" ImageUrl="~/Images/OEM/Faurecia/Logo.png"
                        runat="server" />
                </td>
