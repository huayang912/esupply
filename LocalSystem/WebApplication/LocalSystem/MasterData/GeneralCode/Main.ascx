<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Main.ascx.cs" Inherits="MasterData_GeneralCode_EntityOpt" %>
...
<asp:ObjectDataSource ID="ODS_GV_EntityOpt" runat="server" TypeName="com.LocalSystem.Web.EntityPreferenceMgrProxy"
    DataObjectTypeName="com.LocalSystem.Entity.MasterData.EntityPreference" UpdateMethod="UpdateEntityPreference"
