...
namespace com.LocalSystem.Service.MasterData.Impl
{
    ...
    public class CodeMasterMgr : CodeMasterBaseMgr, ICodeMasterMgr
    {
        ...
        public override IList<CodeMaster> GetAllCodeMaster()
        {
...
{
    [Transactional]
    public partial class CodeMasterMgrE : com.LocalSystem.Service.MasterData.Impl.CodeMasterMgr, ICodeMasterMgrE
    {
