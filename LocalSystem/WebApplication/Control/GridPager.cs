...
/// </summary>
namespace com.LocalSystem.Control
{
    ...
    public class GridPager : Panel, INamingContainer, IPostBackEventHandler, IPostBackDataHandler
    {
        ...
        public string NamedQueryTypeName
        {
            get
            {
                ...
                return (obj == null) ? "com.LocalSystem.Web.NamedQueryMgrProxy" : (string)obj;
            }
            set
            {
        ...
        //    {
        //        com.LocalSystem.Entity.MasterData.NamedQuery namedQuery = GenerateNameQuery();
        ...
        //private com.LocalSystem.Entity.MasterData.NamedQuery GenerateNameQuery()
        //{
        //    com.LocalSystem.Entity.MasterData.NamedQuery namedQuery = new com.LocalSystem.Entity.MasterData.NamedQuery();
        //    User user = new SessionHelper(this.Page).CurrentUser;
