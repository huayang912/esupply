 ...
 * 
 * <pre>
 *      &lt;bean id="fooDao" class="com.faurecia.dao.hibernate.GenericDaoHibernate"&gt;
 *          &lt;constructor-arg value="com.faurecia.model.Foo"/&gt;
...
public class GenericDaoHibernate<T, PK extends Serializable> extends HibernateDaoSupport implements GenericDao<T, PK> {
	...
	public List find(String hql, Object objectValue) {
		return getHibernateTemplate().find(hql, objectValue);
	}

	@SuppressWarnings("unchecked")
	public List find(String hql, Object[] objectValues) {
		return getHibernateTemplate().find(hql, objectValues);
	}
