...
public class DeliveryOrderExportUtil {
	...
	public static InputStream printPalletLabel(String localAbsolutPath, String backGroupImageName, DeliveryOrder deliveryOrder)
		...
		try {
			...
			cb.showTextAligned(PdfContentByte.ALIGN_CENTER, deliveryOrder.getPlantSupplier().getSupplier().getCode(), 300, 575, 0);
			cb.endText();

			// supplier name
			cb.beginText();
			cb.setFontAndSize(simBf, 20);
			cb.showTextAligned(PdfContentByte.ALIGN_CENTER, deliveryOrder.getPlantSupplier().getSupplierName(), 300, 535, 0);
			cb.endText();
			...
			cb.beginText();
			cb.setFontAndSize(dinBf, 50);
			cb.showTextAligned(PdfContentByte.ALIGN_CENTER, "99", 460, 450, 0);
			cb.endText();
			...
			cb.showTextAligned(PdfContentByte.ALIGN_CENTER, "77", 300, 150, 0);
			cb.endText();
