...
<head>
<title><fmt:message key="roleResource.title" /></title>
<meta name="heading" content="<fmt:message key='roleResource.heading'/>" />
...
<s:form id="roleResourceForm" action="editRoleResource"
	...
	<table style="margin: 0px">
		<tr>
			<td><label class="desc"><fmt:message
				key="roleResource.Role" /></label></td>
	...
	<table class="pickList" style="width: 100%">
		<tr>
			<th class="pickLabel"><label class="required"><fmt:message
				key="roleResource.availableResources" /></label></th>
			<td></td>
			<th class="pickLabel"><label class="required"><fmt:message
				key="roleResource.resources" /></label></th>
		</tr>
		<c:set var="leftList" value="${availableResources}" scope="request" />
		<s:set name="rightList" value="role.resourceList" scope="request" />
...
<script type="text/javascript">
    Form.focusFirstElement($("roleResourceForm"));
