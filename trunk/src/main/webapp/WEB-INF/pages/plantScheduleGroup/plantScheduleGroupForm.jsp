...
<s:form id="plantScheduleGroupForm" action="savePlantScheduleGroup"
	...
	<li style="display: none"><input type="hidden"
		name="plantScheduleGroup.id" value="${plantScheduleGroup.id}" /> <s:if
		test="plantScheduleGroup.plant != null">
		<input type="hidden" name="plantScheduleGroup.plant.code"
			value="${plantScheduleGroup.plant.code}" />
	</s:if></li>
	<c:set var="buttons">
	...
	<table>
		<tr>
			<td><label class="desc"><fmt:message
				key="plantScheduleGroup.isDefault" /></label><s:checkbox
				key="plantScheduleGroup.isDefault" theme="simple" /></td>
			<td><label class="desc"><fmt:message
				key="plantScheduleGroup.allowOverDateDeliver" /></label><s:checkbox
				key="plantScheduleGroup.allowOverDateDeliver" theme="simple" /></td>
			<td><label class="desc"><fmt:message
